...
def build_model(d):
    ...
    adsorbate.rotate(103.9998 / 2., "x", center="COM")
...
def run(ii, fp_params, d0, delta_d, n):
    for jj in range(n):
        work_dir = "calc.001/task.%03d.%06d" % (ii, jj)
...
if __name__ == "__main__":
    ...
    run(0, fp_params, 2.5, 0.2, 10)
    run(2, fp_params, 5.0, 0.5, 6)
    ...
    run(1, fp_params, 2.5, 0.2, 10)
    run(3, fp_params, 5.0, 0.5, 6)
