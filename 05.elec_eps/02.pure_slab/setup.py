...
atoms = build.fcc111("Pt", (6, 6, 6), 3.97605, periodic=True, vacuum=20.)
...
for ii, delta_v in enumerate(delta_vs):
                    ...
                    "IMPLICIT": {
                        ...
                        "DIRICHLET_BC": {
                            "AA_PLANAR": [{
                                ...
                                "XY",
                                "X_XTNT":
                                "0.0 %.4f" % atoms.cell[0][0],
                                "Y_XTNT":
                                "0.0 %.4f" % atoms.cell[1][1],
                                "INTERCEPT":
                                5.0,
                                "PERIODIC_REGION":
                                ".TRUE."
    ...
    cp2k_inp = Cp2kInput(atoms, hartree=True, totden=True, eden=True,
